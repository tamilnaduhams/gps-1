...
public class GeneralSettingsManagedBean implements Serializable {
	...
	public void activationParametre(GeneralSettings generalSettings) {
		try {
			...
			JsfUtil.addSuccessMessage(
					"" + (generalSettings.getEnabled() ? "Activation" : "Désactivation") + " du paramètre");
		} catch (Exception ex) {
	...
	public static class GeneralSettingsManagedBeanConverter implements Converter {
		...
		public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
			...
			GeneralSettingsManagedBean ManagedBean = (GeneralSettingsManagedBean) facesContext.getApplication()
					.getELResolver().getValue(facesContext.getELContext(), null, "generalSettingsManagedBean");
		...
		public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
			...
			if (object instanceof GeneralSettings) {
				...
				throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName()
						+ "; expected type: " + GeneralSettings.class.getName());
			}
		}
	}
}
