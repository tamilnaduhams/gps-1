...
public class GpsFilterSecurityMetadataSource implements FilterInvocationSecurityMetadataSource {
	...
	private void loadResourceDefine() {
		try {
			...
			List<Fonctionnalite> listFonctionnalites = (List<Fonctionnalite>) fonctionnaliteFacade
			...
			logger.error("Could not lookup for EJB CollaborateurFacadeLocal with lookup path "
					+ FONCTIONNALITE_EJB_LOOKUP_PATH);
			ex.printStackTrace();
		}
	}
	...
	/**
	 * @param listDroitFonctionnaliteByFonctionnalite
	 *            the listDroitFonctionnaliteByFonctionnalite to set
	 */
	public void setListDroitFonctionnaliteByFonctionnalite(
			List<DroitFonctionnalite> listDroitFonctionnaliteByFonctionnalite) {
