...
public class SendSMSManagedBean implements Serializable {
    ...
    public Account getCompteDispo(Service service) {
        ...
        while (i <= service.getAccountList().size() && !service.getAccountList().isEmpty()) {
            if (("0.00000000".equals(service.getAccountList().get(i).getBalance()) && "Nexmo".equals(service.getNomService()))  ) {
                i++;
            } else {
          ...
          System.out.println("Compte-----" + compte);
            if ("Modem".equals(compte.getIdService().getNomService())) {
                ...
                try {
                    ...
                    FacesContext.getCurrentInstance().addMessage("Successfull", new FacesMessage(FacesMessage.SEVERITY_INFO, "Succés d'envoi Modem", "Succés d'envoi Modem"));
                    ...
                    FacesContext.getCurrentInstance().addMessage("Echec", new FacesMessage(FacesMessage.SEVERITY_ERROR, "Echec d'envoi Modem", "Echec d'envoi Modem"));
                    sms.setDestinataires(destinataires);
                    sms.setMessage(texte);
                    sms.setDateEnvoi(new Date());
                    sms.setAccountId(compte);
                ...
                if ("Nexmo".equals(compte.getIdService().getNomService())) {
                    ...
                    try {
                        ...
                        if (sendNexmo.getCompte() != null) {
                            ...
                            JsfUtil.executeScript("carDialog.hide();");
                            FacesContext.getCurrentInstance().addMessage("Successfull", new FacesMessage(FacesMessage.SEVERITY_INFO, "Succés d'envoi Nexmo", "Succés d'envoi Nexmo"));
                            sms.setDestinataires(destinataires);
                            sms.setMessage(texte);
                            sms.setDateEnvoi(new Date());
                            sms.setAccountId(compte);
                            ...
                            FacesContext.getCurrentInstance().addMessage("Echec", new FacesMessage(FacesMessage.SEVERITY_ERROR, "Echec d'envoi 1", "Echec d'envoi 1"));
                            sms.setDestinataires(destinataires);
                            sms.setMessage(texte);
                            sms.setDateEnvoi(new Date());
                            sms.setAccountId(compte);
                        ...
                        FacesContext.getCurrentInstance().addMessage("Echec", new FacesMessage(FacesMessage.SEVERITY_ERROR, "Echec d'envoi", "Echec d'envoi"));
                        sms.setDestinataires(destinataires);
                        sms.setMessage(texte);
                        sms.setDateEnvoi(new Date());
                        sms.setAccountId(compte);
                    ...
                    if ("RedOxygen".equals(compte.getIdService().getNomService())) {
                        ...
                        try {
                            ...
                            JsfUtil.executeScript("carDialog.hide();");
                            FacesContext.getCurrentInstance().addMessage("Successfull", new FacesMessage(FacesMessage.SEVERITY_INFO, "Succés d'envoi RedOxygen", "Succés d'envoi RedOxygen"));
                        } catch (Exception e) {
                            FacesContext.getCurrentInstance().addMessage("Echec", new FacesMessage(FacesMessage.SEVERITY_ERROR, "Echec d'envoi RedOxygen", "Echec d'envoi RedOxygen"));
                            sms.setDestinataires(destinataires);
                            sms.setMessage(texte);
                            sms.setDateEnvoi(new Date());
                            sms.setAccountId(compte);
