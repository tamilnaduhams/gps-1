...
public class Login implements Serializable {
    ...
    private String langueLocale, dir, ancienPassWord, newPassWord, confPassWord, urlAvatar = "/resources/images/avatar/default.png";
    ...
    public void init() {
        ...
        try {
            ...
            if(gsLongitude != null) setLongitude(gsLongitude.getSettingValue());
            if(gsLatitude != null) setLatitude(gsLatitude.getSettingValue());
    ...
    public void resolveConnectedUser() throws Exception {
        ...
        if (userName != null && !userName.isEmpty()) {
            ...
            if (getConnectedUser() != null) {
                ...
                if (userRoles != null) {
                    urlAvatar = getConnectedUser().getAvatar() == null ? "/resources/images/avatar/default.jpg" : "/static/images/avatar/" + getConnectedUser().getAvatar();
    ...
    public boolean connectedUserHasRole(String roleName) {
        if (StringUtils.isNotBlank(roleName) && userRolesMap != null && !userRolesMap.isEmpty() && userRolesMap.containsKey(roleName)) {
            return true;
        }
        return false;
    }
    ...
    public void saveLifeTimeMessage() {
        utilisateurFacade.edit(getConnectedUser());
        JsfUtil.addSuccessMessage("La durée d'affichage des notifications a été mise à jour, le changement prendra effet à partir de la prochaine reconnexion !");
    }
    ...
    public Boolean isConnectedUserAllowed(String url) {
        if (getConnectedUser() != null) {
            for (DroitFonctionnalite droitFonctionnalite : getConnectedUser().getIdDroit().getDroitFonctionnaliteList()) {
    ...
    /**
     * @param generalSettingsFacade the generalSettingsFacade to set
     */
