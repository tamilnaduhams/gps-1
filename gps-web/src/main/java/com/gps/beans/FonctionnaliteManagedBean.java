...
public class FonctionnaliteManagedBean implements Serializable {
		...
		try {
			if (fonctionnaliteFacade.findFonctionnalitesByURL(selectedFonctionnalite.getUrl()).isEmpty()) {
				...
				JsfUtil.addSuccessMessage(
						"La fonctionnalité <" + selectedFonctionnalite.getLibelle() + "> a été ajoutée avec succès !");
				updateListDroitFonctionnalite();
			} else {
			...
			JsfUtil.addErrorMessage("L'opération d'ajout de la fonctionnalité < " + selectedFonctionnalite.getLibelle()
					+ " > a échoué !!!");
			LOGGER.error(e);
		}
	}
	...
	public void update(DroitFonctionnalite authFct) {
		...
		if (authFct.getActive()) {
			JsfUtil.addSuccessMessage("La fonctionnalité <" + authFct.getIdFonctionnalite().getLibelle()
					+ "> a été attribuée au rôle <" + authFct.getIdDroit().getLibelle() + "> avec succès !");
		} else {
			JsfUtil.addSuccessMessage("La fonctionnalité <" + authFct.getIdFonctionnalite().getLibelle()
					+ "> a été retirée du rôle <" + authFct.getIdDroit().getLibelle() + "> avec succès !");
		}
	}
	...
	public void destroy() {
		try {
			List<DroitFonctionnalite> lstDroitsFcts = droitFonctionnaliteFacade
					.findDroitFonctionnalitesByFct(selectedFonctionnalite.getIdFonctionnalite());
			...
			updateListDroitFonctionnalite();
			JsfUtil.addSuccessMessage(
					"La fonctionnalité <" + selectedFonctionnalite.getLibelle() + "> a été supprimée avec succès !");
		} catch (Exception e) {
			LOGGER.error(e);
			JsfUtil.addErrorMessage("L'opération de suppression de la fonctionnalité < "
					+ selectedFonctionnalite.getLibelle() + " > a échoué !!!");
		}
	}

	public void prepareDetails() {
		setListDroitFonctionnalite(
				droitFonctionnaliteFacade.findDroitFonctionnalitesByFct(selectedFonctionnalite.getIdFonctionnalite()));
	}
	...
	public void findAllDroitFonctionnaliteByMenu() {
		try {
			setListDroitFonctionnalite(
					droitFonctionnaliteFacade.findDroitFonctionnalitesByMenu(selectedMenu.getIdMenu()));
		} catch (Exception ex) {
			LOGGER.error(ex);
		}
	}
	...
	public void findAlDroitFonctionnaliteByDroit() {
		try {
			setListDroitFonctionnalite(
					droitFonctionnaliteFacade.findDroitFonctionnalitesByDroit(getSelectedDroit().getIdDroit()));
		} catch (Exception ex) {
			LOGGER.error(ex);
		}
	}
	...
	public void findAllDroitFonctionnaliteByMenuAndDroit() {
		try {
			setListDroitFonctionnalite(droitFonctionnaliteFacade
					.findDroitFonctionnalitesByMenuAndDroit(selectedMenu.getIdMenu(), getSelectedDroit().getIdDroit()));
		} catch (Exception ex) {
			LOGGER.error(ex);
		}
	}
	...
	/**
	 * @param fonctionnaliteFacade
	 *            the fonctionnaliteFacade to set
	 */
	...
	/**
	 * @param selectedFonctionnalite
	 *            the selectedFonctionnalite to set
	 */
	...
	/**
	 * @param listDroitFonctionnalite
	 *            the listDroitFonctionnalite to set
	 */
	...
	/**
	 * @param selectedDroits
	 *            the selectedDroits to set
	 */
	...
	/**
	 * @param selectedDroitFonctionnalite
	 *            the selectedDroitFonctionnalite to set
	 */
