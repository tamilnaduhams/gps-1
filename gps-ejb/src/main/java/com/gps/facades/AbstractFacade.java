...
public abstract class AbstractFacade {
	...
	public List findByEqualCriteriaOnSameAttribute(List<String> values, final Class c, String operateur,
			String constructeur, String attribute) {
		StringBuilder query = new StringBuilder();
		if (constructeur != null && constructeur.length() > 0) {
			query.append("SELECT ");
			query.append(constructeur);
	 ...
	 * @return
	 */
	public List findByCriteria(Map<String, String> conditions, Map<String, Object> parameters, final Class c,
			String operateur, String constructeur) {
		StringBuilder query = new StringBuilder();
		if (constructeur != null && constructeur.length() > 0) {
			query.append("SELECT ");
			query.append(constructeur);
	 ...
	 * @return
	 */
	public List findByCriteriaOrderedList(Map<String, String> conditions, final Class c, String operateur,
			String constructeur, String orderBy, String order) {
		StringBuilder query = new StringBuilder();
		if (constructeur != null && constructeur.length() > 0) {
			query.append("SELECT ");
			query.append(constructeur);
	 ...
	 * @return
	 */
	public List findByCriteriaOrderedListManyOrderBy(Map<String, String> conditions, final Class c, String operateur,
			String constructeur, Map<String, String> orderBy) {
		String query = "";
		if (constructeur != null && constructeur.length() > 0) {
	 ...
	 * @return
	 */
	public List findByCriteria(Map<String, String> conditions, final Class c, String operateur, String orderBy,
			String order, String constructeur) {
		StringBuilder query = new StringBuilder();
		if (constructeur != null && constructeur.length() > 0) {
			query.append("SELECT ");
			query.append(constructeur);
	 ...
	 * @return
	 */
	public List findChampsByCriteria(Map<String, String> conditions, final Class c, String operateur,
			String critereDistinction) {
		StringBuilder query = new StringBuilder();
		query.append("SELECT ");
	...
	// * @return
	// */
	// public int deleteByCriteria(Map<String, String> conditions, final Class
	// c, String operateur) {
	// StringBuilder query = new StringBuilder();
	...
	// *
	// */
	// public int updateByCriteria(Map<String, String> conditions, Map<String,
	// String> values, final Class c, String operateur) {
	// StringBuilder query = new StringBuilder();
	// query.append("UPDATE ");
	// query.append(c.getSimpleName());
